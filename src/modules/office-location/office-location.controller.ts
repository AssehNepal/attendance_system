...
export class OfficeLocationController {
  ...
  @ApiResponse({ status: 201, description: 'Office location created successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Returns paginated office locations' })
  ...
  @ApiResponse({ status: 200, description: 'Returns filtered office locations' })
  ...
  @ApiResponse({ status: 200, description: 'Office location updated successfully' })
  update(
  ...
  @ApiResponse({ status: 204, description: 'Office location deleted successfully' })
